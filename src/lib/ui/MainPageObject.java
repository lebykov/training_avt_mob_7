...
public class MainPageObject {
    ...
    public void swipeElementToLeft(String locator, String error_message)
    {
        ...
        // java-client 4.1.2 implementation
//        TouchAction action = new TouchAction(driver);
//        action
...
//                .perform();
        ...
        // java-client 6.1 implementation. Works on both platforms
//        TouchAction action = new TouchAction(driver);
//        action
...
//                .perform();
    ...
    protected By getLocatorByString(String locator_with_type)
    {
        ...
        } else if (by_type.equals("predicate")) {
    ...
    public WebElement waitForElementToBeClickable(String locator, String error_message, long timeoutInSeconds)
    {
        By by = this.getLocatorByString(locator);
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
